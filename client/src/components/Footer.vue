<template>
  <footer>
    ...
    <div class="pay">
      ...
      <img src="static/icons/american-express.svg">
    </div>
    ...
    <div class="contact">
      ...
      <a target="_blank" rel="noopener noreferrer"
        href="https://www.google.ch/maps/place/Sonjas+Haarstyle+%2F+Make-up+Artist/@46.9328917,7.5611601,738m/data=!3m1!1e3!4m13!1m7!3m6!1s0x478e342edf32a533:0xce16060955cd2c49!2sVechigenstrasse+16,+3076+Worb!3b1!8m2!3d46.9327893!4d7.562756!3m4!1s0x478e342edf2eeab3:0xc35c85d84138e2eb!8m2!3d46.9327563!4d7.562753">
        Sonjas-Haarstyle<br>
...
<script>
  export default {
    ...
    data() {
      return {
        times: [
          {day: "Montag", early: "Geschlossen"},
          {day: "Dienstag", early: "08:00 - 12:00", late: "13:30 - 20:00"},
          {day: "Mittwoch", early: "10:00 - 12:00", late: "13:30 - 20:00"},
          {day: "Donnerstag", early: "08:00 - 12:00", late: "13:30 - 18:30"},
          {day: "Freitag", early: "08:00 - 17:00"},
          {day: "Samstag", early: "08:00 - 14:00"},
          {day: "Sonntag", early: "Geschlossen",}
        ]
      }
    },
    methods: {
